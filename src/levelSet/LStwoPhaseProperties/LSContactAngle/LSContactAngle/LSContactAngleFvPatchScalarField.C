...
namespace Foam
{
    defineTypeNameAndDebug(LSContactAngleFvPatchScalarField, 0);

    template<>
    const char* Foam::NamedEnum
    <
        Foam::LSContactAngleFvPatchScalarField::limitControls,
        4
    >::names[] =
    {
        "none",
...
<
    Foam::LSContactAngleFvPatchScalarField::limitControls,
    4
> Foam::LSContactAngleFvPatchScalarField::limitControlNames_;


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::LSContactAngleFvPatchScalarField::LSContactAngleFvPatchScalarField
(
    const fvPatch& p,
...
Foam::LSContactAngleFvPatchScalarField::LSContactAngleFvPatchScalarField
(
    const LSContactAngleFvPatchScalarField& acpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::LSContactAngleFvPatchScalarField::evaluate
(
...
void Foam::LSContactAngleFvPatchScalarField::write
(
    Ostream& os
) const
{
