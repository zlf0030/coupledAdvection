...
#include "dynamicLSContactAngleFvPatchScalarField.H"
...
dynamicLSContactAngleFvPatchScalarField
(
    const dynamicLSContactAngleFvPatchScalarField& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::dynamicLSContactAngleFvPatchScalarField::theta
(
...
void Foam::dynamicLSContactAngleFvPatchScalarField::write(Ostream& os) const
{
