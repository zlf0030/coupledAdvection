...
#include "timeVaryingLSContactAngleFvPatchScalarField.H"
...
Foam::timeVaryingLSContactAngleFvPatchScalarField::
timeVaryingLSContactAngleFvPatchScalarField
(
    const fvPatch& p,
...
timeVaryingLSContactAngleFvPatchScalarField
(
    const timeVaryingLSContactAngleFvPatchScalarField& gcpsf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::timeVaryingLSContactAngleFvPatchScalarField::theta
(
...
void Foam::timeVaryingLSContactAngleFvPatchScalarField::write
(
    Ostream& os
) const
{
